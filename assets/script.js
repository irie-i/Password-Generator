...
function generatePassword() {
  ...
  if (passLength >= 8 && passLength <= 128) {
    window.alert("You chose: " + passLength);
  }
 ...
 if (uCase == false && lCase == false && specChar == false && numChoice == false) {
    console.log("One of the character options must be selected");
    return "One of the character options must be selected. Please try again.";
  }
